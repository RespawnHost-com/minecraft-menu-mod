...
public class OrderScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(CycleButton.<Boolean>builder(hourly -> Component.translatable(hourly
                        ...
                        : LangKeys.ORDER_MODEL_FIXED), hourlySelected)
        ...
        CycleButton<Integer> termButton = CycleButton.<Integer>builder(days ->
                        Component.translatable(LangKeys.ORDER_TERM_DAYS, days), termDaysSelected)
        ...
        addRenderableWidget(CycleButton.<String>builder(region ->
                        Component.translatable(LangKeys.ORDER_REGION, region.toUpperCase(Locale.ROOT)), regionSelected)
        ...
        addRenderableWidget(Button.builder(Component.translatable(LangKeys.CONFIG_TITLE),
                ...
                .bounds(this.width - 116, 6, 110, 20)
                .build());
    ...
    public void extractRenderState(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        for (ServerPlan plan : current) {
            ...
            extractor.text(this.font, nameLine, LIST_LEFT_MARGIN, y, 0xFFFFFF);
            ...
            extractor.text(this.font, details, LIST_LEFT_MARGIN, y + 12, 0xAAAAAA);
            y += ROW_HEIGHT;
        }
