...
public class OrderScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.translatable("screen.respawnhost_integration.config.title"),
                        button -> {
                            if (this.client != null) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (modpackSlug != null) {
            ...
            context.drawCenteredTextWithShadow(this.textRenderer,
                    Text.translatable("screen.respawnhost_integration.order.modpack_detected", displayName),
        ...
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.translatable("screen.respawnhost_integration.order.checkout_hint"),
